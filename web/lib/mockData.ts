...
export const MOCK_MARKETPLACES = [
  {
    ...
    type: 'Clinic',
    name: 'Paws & Claws Vet',
    description: 'Full service vet clinic with 24/7 emergency support.',
  },
  {
    id: 'm2',
    lat: 20.2861,
    ...
    type: 'Grooming',
    name: 'Fluffy Pet Spa',
    description: 'Premium pet grooming and organic paw treatments.',
  },
  {
    id: 'm3',
    lat: 20.3450,
    lng: 85.8150,
    type: 'Clinic',
    name: 'Kalinga Vet Center',
    description: 'Expert surgery and diagnostic services in Patia.',
  },
  {
    id: 'm4',
    lat: 20.2650,
    ...
    type: 'Pet Shop',
    name: 'Pet Planet',
    description: 'One-stop shop for premium pet food and accessories.',
  },
  {
    id: 'm5',
    lat: 20.3120,
    ...
    type: 'Grooming',
    name: 'Royal Groomers',
    description: 'Mobile grooming services delivered to your doorstep.',
  },
  {
    id: 'm6',
    lat: 20.2920,
    lng: 85.8600,
    type: 'Shelter',
    name: 'Vetaura Rescue Hub',
    description: 'Our primary rescue and temporary shelter center.',
  },
];
