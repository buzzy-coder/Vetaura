  ...
  return (
    <div style={{
      ...
      <motion.div
        ...
        style={{
          background: '#F8FAFC', borderRadius: '1.5rem', width: '90%', maxWidth: '600px', maxHeight: '85vh',
      ...
      >
        ...
        <div style={{ display: 'flex', gap: '0.5rem', marginBottom: '1.5rem' }}>
          <div style={{
            display: 'flex', alignItems: 'center', background: 'white', border: '1px solid #E2E8F0', padding: '0.5rem 1rem', borderRadius: '0.75rem', flex: 1
          }}>
        ...
        <div style={{ overflowY: 'auto', flex: 1, paddingRight: '0.5rem', display: 'flex', flexDirection: 'column', gap: '1rem' }}>
          {loading ? (
            <div style={{ textAlign: 'center', padding: '3rem 0', color: '#94A3B8' }}>Loading volunteers...</div>
          ) : volunteers.length === 0 ? (
            <div style={{ textAlign: 'center', padding: '3rem 0', color: '#94A3B8' }}>No volunteers found in this zone.</div>
          ) : (
            volunteers.map(v => {
              ...
              <div key={v.id} style={{ 
                ...
                <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                  <div style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
                    ...
                    <div>
                      ...
                      <div style={{ fontSize: '0.8rem', color: '#64748B', display: 'flex', gap: '0.5rem', flexWrap: 'wrap', marginTop: '0.2rem' }}>
                ...
                <AnimatePresence>
                  {isSelected && (
                    ...
                    >
                      <div style={{ 
                        borderTop: '1px solid #E2E8F0', paddingTop: '1rem', marginTop: '0.5rem',
